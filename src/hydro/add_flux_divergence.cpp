...
// TODO(felker): consider combining with DustFluids PassiveScalars implementation + (see 57cfe28b)
// (may rename to AddPhysicalFluxDivergence or AddQuantityFluxDivergence to explicitly
// distinguish from CoordTerms)
// (may rename to AddHydroFluxDivergence and AddDustFluidsFluxDivergenceand AddScalarsFluxDivergence, if
